        ...
        <div className="w-full lg:px-16 h-full px-10 pt-20 text-white  top-0 left-0 absolute grid lg:grid-cols-2 grid-cols-1 gap-5 lg:place-items-center">
          <div className="min-w-[1096px]:text-center text-start">
            ...
            <p className="text-xl leading-9">
              Android - bu smartfon va planshet kabi mobil qurilmalar uchun
              ochiq manba va asoslangan operatsion tizimLinux-ga Android
              o'zining dasturlash tili sifatida Java-dan foydalanadi. Sizga Java
              dan boshlang'ich tushincha kerak.
            </p>
          </div>
          <iframe
