        ...
        <div className="w-full lg:px-16 h-full px-10 pt-20 text-white  top-0 left-0 absolute grid lg:grid-cols-2 grid-cols-1 gap-5 lg:place-items-center">
          <div className="min-w-[1096px]:text-center text-start">
            ...
            <p className="text-xl leading-9">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi nulla error libero dicta id optio corporis? Sapiente pariatur aut incidunt aspernatur. Voluptatem sunt molestiae qui minima ex necessitatibus! Magni, in!
            </p>
          </div>
          <iframe
