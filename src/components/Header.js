...
function Header() {
  return (
    <div className='bg-[#F8F8F8] pt-16 flex justify-between items-center w-full h-[110vh] relative px-16 overflow-hidden'>
        <div>
        ...
        <img src="./images/abs-1.png" className='absolute bottom-0 left-0' alt='abs' />
