    ...
    <div>
      ...
      <div className="px-16 bg-white pt-10 max-lg:px-12 ">
        <div className="flex justify-between items-center my-16 max-md:flex-wrap ">
          ...
          <div className="animate__fadeInRight animate__animated wow w-2/3 text-[#3D3D3D] font-medium text-xl max-lg:text-base leading-[30px] max-md:text-sm max-md:mt-10 max-[430px]:w-full ">
            <p>
              ...
              akdemiyamizni 500 ga yaqin o`quvchilar bitirgan. Shu vaqt mobaynida
        ...
        <div className="py-10 animate__fadeInLeft wow">
          <h1 className="text-[#1D537C] font-bold text-[46px] max-lg:text-[38px] max-md:text-[30px] max-[430px]:text-[23px]">Zamonaviy kasblardan <br /> birini o’rganing</h1>
        </div>
        <div className="flex justify-around flex-wrap gap-y-5">
          ...
          <div className="card-transparent w-[380px] max-lg:w-[350px] max-md:w-[300px] px-5 py-3">
            <div className="animate__fadeInRight wow">
              ...
              <p className=" text-[#002D4F] py-4 text-lg leading-[34px] max-md:text-base">Siz bunda Microsoft <br /> kompaniyasining Windows <br /> operatsion tizimni o’rganasiz...</p>
              <Link to='/savodxonlik' className="text-[#0A66BA] text-xl hover:underline transition-all duration-150">Batafsil →</Link>
            </div>
          </div>
        </div>
        <div className="py-10">
          <h1 className="animate__fadeInLeft wow text-[#1D537C] font-bold text-[46px] max-lg:text-[40px] max-[430px]:text-[23px]">Bizning jamoamiz bilan <br /> tanishing</h1>
